...
def _sa_bind_team():
    ...
    class Team(Team, cassiopeia.type.dto.common.BaseDB):
        ...
        bans = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.BannedChampion", cascade="all, delete-orphan", passive_deletes=True)
...
def _sa_bind_participant_timeline():
    ...
    class ParticipantTimeline(ParticipantTimeline, cassiopeia.type.dto.common.BaseDB):
        ...
        ancientGolemAssistsPerMinCounts = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='ancientGolemAssistsPerMinCounts')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        ancientGolemKillsPerMinCounts = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='ancientGolemKillsPerMinCounts')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        assistedLaneDeathsPerMinDeltas = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='assistedLaneDeathsPerMinDeltas')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        assistedLaneKillsPerMinDeltas = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='assistedLaneKillsPerMinDeltas')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        baronAssistsPerMinCounts = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='baronAssistsPerMinCounts')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        baronKillsPerMinCounts = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='baronKillsPerMinCounts')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        creepsPerMinDeltas = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='creepsPerMinDeltas')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        csDiffPerMinDeltas = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='csDiffPerMinDeltas')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        damageTakenDiffPerMinDeltas = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='damageTakenDiffPerMinDeltas')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        damageTakenPerMinDeltas = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='damageTakenPerMinDeltas')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        dragonAssistsPerMinCounts = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='dragonAssistsPerMinCounts')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        dragonKillsPerMinCounts = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='dragonKillsPerMinCounts')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        elderLizardAssistsPerMinCounts = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='elderLizardAssistsPerMinCounts')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        elderLizardKillsPerMinCounts = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='elderLizardKillsPerMinCounts')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        goldPerMinDeltas = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='goldPerMinDeltas')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        inhibitorAssistsPerMinCounts = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='inhibitorAssistsPerMinCounts')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        inhibitorKillsPerMinCounts = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='inhibitorKillsPerMinCounts')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        lane = sqlalchemy.Column(sqlalchemy.String(30))
        role = sqlalchemy.Column(sqlalchemy.String(30))
        towerAssistsPerMinCounts = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='towerAssistsPerMinCounts')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        towerKillsPerMinCounts = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='towerKillsPerMinCounts')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        towerKillsPerMinDeltas = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='towerKillsPerMinDeltas')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        vilemawAssistsPerMinCounts = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='vilemawAssistsPerMinCounts')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        vilemawKillsPerMinCounts = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='vilemawKillsPerMinCounts')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
        wardsPerMinDeltas = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.ParticipantTimelineData", primaryjoin="and_(cassiopeia.type.dto.matchlite.ParticipantTimeline._id==cassiopeia.type.dto.matchlite.ParticipantTimelineData._timeline_id, cassiopeia.type.dto.matchlite.ParticipantTimelineData._type=='wardsPerMinDeltas')", uselist=False, cascade="all, delete-orphan", passive_deletes=True)
...
def _sa_bind_frame():
    ...
    class Frame(Frame, cassiopeia.type.dto.common.BaseDB):
        ...
        events = sqlalchemy.orm.relationship("cassiopeia.type.dto.matchlite.Event", cascade="all, delete-orphan", passive_deletes=True)
