...
class Match(cassiopeia.type.core.common.CassiopeiaObject):
    dto_type = cassiopeia.type.dto.matchlite.MatchDetail
...
###############################
def _sa_rebind_all():
    Match.dto_type = cassiopeia.type.dto.matchlite.MatchDetail
    Team.dto_type = cassiopeia.type.dto.matchlite.Team
    Timeline.dto_type = cassiopeia.type.dto.matchlite.Timeline
    ParticipantStats.dto_type = cassiopeia.type.dto.matchlite.ParticipantStats
    ParticipantTimeline.dto_type = cassiopeia.type.dto.matchlite.ParticipantTimeline
    Ban.dto_type = cassiopeia.type.dto.matchlite.BannedChampion
    Frame.dto_type = cassiopeia.type.dto.matchlite.Frame
    ParticipantTimelineData.dto_type = cassiopeia.type.dto.matchlite.ParticipantTimelineData
    Event.dto_type = cassiopeia.type.dto.matchlite.Event
    ParticipantFrame.dto_type = cassiopeia.type.dto.matchlite.ParticipantFrame
    Position.dto_type = cassiopeia.type.dto.matchlite.Position
